...
class ProcessBuilder {
    ...
    _constructJVMArguments112(mods, tempNativePath){
        ...
        if(process.platform === 'darwin'){
            args.push('-Xdock:name=TheEndNetworkLauncher')
            args.push('-Xdock:icon=' + path.join(__dirname, '..', 'images', 'server.png'))
        }
    ...
    _constructJVMArguments113(mods, tempNativePath){
        ...
        // Java Arguments
        if(process.platform === 'darwin'){
            args.push('-Xdock:name=theEndMcLauncher')
                ...
                if(argDiscovery.test(args[i])){
                    ...
                    switch(identifier){
                        ...
                        case 'natives_directory':
                            ...
                            break
                        case 'launcher_name':
                            val = args[i].replace(argDiscovery, 'theEnd-Launcher')
                            break
